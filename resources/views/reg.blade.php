            ...
            <div class="page-content-wrapper bg-transparent m-0">
                <div class="height-10 w-100 shadow-lg px-4 bg-brand-gradient">
                    <div class="d-flex align-items-center container p-0">
                        ...
                        <a href="/in" class="btn-link text-white ml-auto ml-sm-0">
                            Войти
                        </a>
                    </div>
                </div>
                            ...
                            <div class="col-xl-6 ml-auto mr-auto">
                                <div class="card p-4 rounded-plus bg-faded">
                                    ...
                                    <form id="js-login" action="/{{Route::current()->uri}}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label class="form-label" for="userpasswordagain">Повторите пароль <br></label>
                                            <input type="password" name="password_again" id="userpasswordagain" class="form-control" placeholder="" >
